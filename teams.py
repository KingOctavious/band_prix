...
ALL_TEAMS = [
  ...
  Team('ViscDuds', tcod.white, Vehicle(vehicle_bodies.v_bod_1)),
  ...
  Team('Herald of the Boulders', tcod.gray, Vehicle(vehicle_bodies.v_bod_1)),
  Team('PrimeThem', tcod.sepia, Vehicle(vehicle_bodies.v_bod_1)),
  Team('Dreaded Blimp', tcod.turquoise, Vehicle(vehicle_bodies.v_bod_1)),
  Team('Pink Boyd', tcod.pink, Vehicle(vehicle_bodies.v_bod_1)),
]
